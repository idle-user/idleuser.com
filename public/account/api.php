...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    ...
    <div class="input-group mb-3">
        <input type="password" class="form-control" id="authTokenInput"
               value="<?= $_SESSION['profile']['auth_token'] ?>" readonly>
        <div class="input-group-append">
            <button class="btn btn-outline-secondary" type="button" id="showHideButton" onclick="showHide()"
                    title='hide password'><i class="fas fa-eye"></i></button>
            <a class="btn btn-outline-primary float-right" type="button" data-toggle="modal"
               data-target="#newTokenModal" title="New Token"><i class="fas fa-sync"></i></a>
        </div>
    </div>

    <div class="modal fade" id="newTokenModal" tabindex="-1" role="dialog" aria-labelledby="newTokenModalLabel"
         aria-hidden="true">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-label-group">
                            <input type="username" id="inputUsername" class="form-control" placeholder="Username"
                                   name="username" value="<?= $_SESSION['profile']['username'] ?>" hidden readonly>
                        </div>
                        <div class="form-label-group">
                            <input type="password" id="inputPassword" class="form-control"
                                   placeholder="Confirm Password" name="secret" required autofocus>
                        </div>
                    </div>
