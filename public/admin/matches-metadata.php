...
<main role="main" class="container">
    ...
    <div class="my-3 p-3 bg-white rounded shadow-sm">
                ...
                <div class="form-row pb-2">
                    ...
                    <div class="col-md-3 mb-1">
                        <input type="datetime-local" class="form-control" name="start_time"
                               value="<?php echo str_replace(' ', 'T', $ue['date_time']) ?>">
                    </div>
                    <div class="col-md-2 mb-1">
                        <select name="is_ppv" class="form-control">
                            <option <?php echo $ue['ppv'] ? 'selected' : '' ?>>PPV</option>
                            <option <?php echo !$ue['ppv'] ? 'selected' : '' ?>>Not PPV</option>
                        </select>
                    </div>
        ...
        <form method="post" class="container">
            <div class="form-row mt-2">
                ...
                <div class="col-md-2 mb-1">
                    <select name="is_ppv" class="form-control">
                        <option selected>PPV</option>
                        <option>Not PPV</option>
                    </select>
                </div>
                <div class="col-md-1 mb-1">
                ...
                <div class="form-row pb-2">
                    ...
                    <div class="col-md-7 mb-1">
                        <input type="text" class="form-control" name="image_url"
                               value="<?php echo $brand['image_url'] ?>">
                    </div>
                    <div class="col-md-1 mb-1">
                        <button type="submit" class="form-control btn btn-primary">Update</button>
                    </div>
    ...
    <div class="my-3 p-3 bg-white rounded shadow-sm">
        ...
        <?php foreach ($match_type_list as $match_type) { ?>
            <form method="post" class="container">
                <div class="form-row pb-2">
                    <input type="text" class="form-control d-none" name="match_type_id"
                           value="<?php echo $match_type['id'] ?>">
                    <div class="col-md-11 mb-1">
