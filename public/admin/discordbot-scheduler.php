    ...
    <div class="my-3 p-3 bg-white rounded shadow-sm">
            ...
            <form method="post" class="container">
                <div class="form-row pb-2">
                    ...
                    <div class="col-md-3 mb-1 text-center">
                        <input type="text" class="form-control input-group-text" name="name"
                               value="<?php echo $ds['name'] ?>">
                        <textarea class="form-control font-italic"
                                  name="description"><?php echo $ds['description'] ?></textarea>
                    </div>
                    <div class="col-md-4 mb-2 text-center">
                        <textarea rows="3" class="form-control" name="discord_message"
                                  placeholder="Discord Message"><?php echo $ds['message'] ?></textarea>
                        <textarea rows="3" class="form-control" name="twitter_message"
                                  placeholder="Twitter Message"><?php echo $ds['tweet'] ?></textarea>
                    </div>
                    <div class="form-group-sm col-md-2 mb-1">
                        <input type="time" class="form-control" name="start_time"
                               value="<?php echo $ds['start_time'] ?>">
                        ...
                        <div class="form-check-inline">
                            <input type="checkbox"
                                   name="wed_active" <?php echo $ds['wednesday_flag'] ? 'checked' : '' ?>>
                            <label class="form-check-label ml-2">Wed</label>
                        </div>
                        <div class="form-check-inline">
                            <input type="checkbox"
                                   name="thu_active" <?php echo $ds['thursday_flag'] ? 'checked' : '' ?>>
                        ...
                        <div class="form-check-inline">
                            <input type="checkbox"
                                   name="sat_active" <?php echo $ds['saturday_flag'] ? 'checked' : '' ?>>
                            <label class="form-check-label ml-2">Sat</label>
                        </div>
                    </div>
                    <div class="col-md-2 mb-1">
                        <select name="is_active" class="form-control">
                            <option <?php echo $ds['active'] ? 'selected' : '' ?>>Active</option>
                            <option <?php echo !$ds['active'] ? 'selected' : '' ?>>Disabled</option>
                        </select>
                    </div>
        ...
        <form method="post" class="container">
            <div class="form-row pb-2">
                ...
                <div class="col-md-3 mb-1 text-center">
                    <input type="text" class="form-control input-group-text" name="name" placeholder="Schedule Name"
                           required>
                    <textarea class="form-control font-italic" name="description" placeholder="Description"></textarea>
                </div>
                <div class="col-md-4 mb-2 text-center">
                    <textarea rows="3" class="form-control" name="discord_message" placeholder="Discord Message"
                              required></textarea>
                    <textarea rows="3" class="form-control" name="twitter_message"
                              placeholder="Twitter Message"></textarea>
                </div>
                <div class="form-group-sm col-md-2 mb-1">
