...
usort($matches_base_data['matches_brand'], function ($a, $b) {
...
<main role="main" class="container">
    ...
    <div class="my-3 p-3 bg-white rounded shadow-sm">
        <form method="get">
            <label class="my-1 mr-2" for="selectSuperstarSelector">Superstar Selector
                (<?php echo count($superstar_list) ?>)</label>
            <select class="custom-select my-1 mr-sm-2" id="selectSuperstarSelector" id="superstar_selected"
                    name="search">
    ...
    <div class="my-3 p-3 bg-white rounded shadow-sm">
        <h6 class="border-bottom border-gray pb-2 mb-0">Superstar
            Editor<?php if ($superstar_info) echo "<small class='float-right'>Last Updated: $superstar_info[last_updated]</small>"; ?></h6>
        <div class="media text-muted pt-3">
            ...
            <?php if ($superstar_info) { ?>
                ...
                <form class="container" method="post">
                    <input type="text" class="form-control d-none" name="superstar_id"
                           value="<?php echo $superstar_info['id'] ?>">
                    <input type="text" class="form-control d-none" name="last_updated"
                           value="<?php echo $superstar_info['last_updated'] ?>">
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            <label for="inputName">Name</label>
                            <input type="text" class="form-control my-1 mr-sm-2" id="inputName" name="name"
                                   placeholder="Superstar Name"
                                   value="<?php echo htmlspecialchars($superstar_info['name']) ?>" required>
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control my-1 mr-sm-2" id="inputPageUrl" name="page_url"
                                   placeholder="Page URL" value="<?php echo $superstar_info['page_url'] ?>">
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="inputImage">Image URL</label>
                            <input type="text" class="form-control my-1 mr-sm-2" id="inputImage" name="image_url"
                                   placeholder="Image URL" value="<?php echo $superstar_info['image_url'] ?>">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="date" class="form-control my-1 mr-sm-2" id="inputDob" name="dob"
                                   value="<?php echo $superstar_info['dob'] ?>">
                        </div>
                        <div class="col-md-1 mb-3">
                            <label for="inputHeight">Height</label>
                            <input type="text" class="form-control my-1 mr-sm-2" id="inputHeight" name="height"
                                   placeholder="Superstar Height" value="<?php echo $superstar_info['height'] ?>">
                        </div>
                        <div class="col-md-1 mb-3">
                            <label for="inputWeight">Weight</label>
                            <input type="text" class="form-control my-1 mr-sm-2" id="inputWeight" name="weight"
                                   placeholder="Superstar Weight" value="<?php echo $superstar_info['weight'] ?>">
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="inputHometown">Hometown</label>
                            <input type="text" class="form-control my-1 mr-sm-2" id="inputHometown" name="hometown"
                                   placeholder="Hometown" value="<?php echo $superstar_info['hometown'] ?>">
                        </div>
                        <div class="col-md-5 mb-3">
                            <label for="inputSignatures">Signature Moves</label>
                            <input type="text" class="form-control my-1 mr-sm-2" id="inputSignatures"
                                   name="signature_move" placeholder="Signature Moves"
                                   value="<?php echo $superstar_info['signature_move'] ?>">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            <label for="inputBio">Bio</label>
                            <textarea rows="10" class="form-control my-1 mr-sm-2" id="inputBio" name="bio"
                                      placeholder="Bio"><?php echo $superstar_info['bio'] ?></textarea>
                        </div>
                    </div>
                ...
                <form class="container" method="post">
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            <label for="inputName">Name</label>
                            <input type="text" class="form-control my-1 mr-sm-2" id="inputName" name="name"
                                   placeholder="Superstar Name" required>
                        </div>
                        <div class="col-md-2 mb-3">
                            <label for="selectBrand">Brand</label>
                            <select class="custom-select my-1 mr-sm-2" id="selectBrand" name="brand_id" required>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-1 mb-3">
                            <label for="inputHeight">Height</label>
                            <input type="text" class="form-control my-1 mr-sm-2" id="inputHeight" name="height"
                                   placeholder="Superstar Height">
                        </div>
                        <div class="col-md-1 mb-3">
                            <label for="inputWeight">Weight</label>
                            <input type="text" class="form-control my-1 mr-sm-2" id="inputWeight" name="weight"
                                   placeholder="Superstar Weight">
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="inputHometown">Hometown</label>
                            <input type="text" class="form-control my-1 mr-sm-2" id="inputHometown" name="hometown"
