...
$season_matches = $db->s7_matches();
$superstar_list = $db->all_superstars();
$matches_base_data = $db->matches_base_data();
usort($matches_base_data['matches_title'], function ($a, $b) {
    return strcmp($a['name'], $b['name']);
});
usort($matches_base_data['matches_match_type'], function ($a, $b) {
    return strcmp($a['name'], $b['name']);
});
...
<main role="main" class="container">
    ...
    <div class="my-3 p-3 bg-white rounded shadow-sm">
        ...
        <?php } else {
            foreach ($open_matches as $om) {
                ...
                <div class="media text-muted pt-3">
                    <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                        <a class="d-block float-right"
                           href="matches-editor?search=<?php echo $om['id'] ?>"><?php echo $om['info_last_updated'] ?></a>
                        <strong class="d-block text-gray-dark"><?php echo $om['event'] . ' - ' . $om['title'] . ' - ' . $om['match_type'] ?></strong>
                        <?php echo $om['contestants'] ?><small
                                class="float-right"><?php echo $om['info_last_updated_by_username'] ?></small>
                    </p>
                </div>
                <?php
            }
    ...
    <div class="my-3 p-3 bg-white rounded shadow-sm">
        <h6 class="border-bottom border-gray pb-2 mb-0">Match
        ...
        <div class="media text-muted pt-3">
            ...
            <?php if ($match_info) { ?>
                ...
                <form class="container" method="post">
                    <input type="text" class="form-control d-none" name="match_id"
                           value="<?php echo $match_info['id'] ?>">
                    <input type="text" class="form-control d-none" name="last_updated"
                           value="<?php echo $match_info['info_last_updated'] ?>">
                    ...
                    <div class="form-group row text-center">
                        <div class="col-sm-12">
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="checkbox" id="inputBetsOpen"
                                       name="bet_open" <?php if ($match_info['bet_open']) echo 'checked'; ?>>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" id="inputMatchNote" name="match_note"
                                   placeholder="Match Note" value="<?php echo $match_info['match_note'] ?>">
                        </div>
                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-row">
                                    <?php foreach ($team as $member) { ?>
                                        <div class="col-md-4">
                                            <select team="<?php echo $team_number ?>" class="custom-select my-1 mr-sm-2"
                                                    name="contestants[<?php echo $team_number ?>][]">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" id="radioTeamWon0"
                                                   name="result" value="0" checked>
                                        ...
                                        foreach ($match_info['contestant_info'] as $team) {
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                       id="radioTeamWon<?php echo $team_number ?>" name="result"
                                                       value="<?php echo $team_number ?>" <?php echo $team_won ? 'checked' : '' ?>>
                                                <label class="form-check-label"
                                                       for="radioTeamWon<?php echo $team_number ?>">Team <?php echo $team_number ?></label>
                                            </div>
                                        <?php } ?>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" id="radioTeamWon999"
                                                   name="result"
                                                   value="999" <?php echo $match_info['team_won'] == '999' ? 'checked' : '' ?>>
                                            <label class="form-check-label" for="radioTeamWon999">No Contest /
                                                DNF</label>
                                        </div>
                                    </div>
                                </div>
                                <label for="inputResult">Result Note</label>
                                <input type="text" class="form-control" id="inputResult" name="result_note"
                                       placeholder="Result Note" value="<?php echo $match_info['winner_note'] ?>">
                            </fieldset>
                        </div>
                    </div>
            ...
            <?php } else { ?>
                ...
                <form class="container" method="post">
                    ...
                    <div class="form-group row text-center">
                        <div class="col-sm-12">
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="checkbox" id="inputBetsOpen" name="bet_open"
                                       checked>
                                <label class="form-check-label" for="inputBetsOpen">Bets Open</label>
                            </div>
                        </div>
