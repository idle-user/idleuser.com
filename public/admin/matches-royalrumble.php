            ...
            <?php foreach($royalrumbles as $rr){ ?>
                <form method="post" class="container">
                    <div class="form-row pb-1">
                        <input type="text" class="form-control d-none" name="royalrumble_id" value="<?php echo $rr['id'] ?>">
                        ...
                        <div class="col-md-4 mb-1">
                            <input type="text" class="form-control" name="description" value="<?php echo $rr['description'] ?>">
                        </div>
                        <div class="col-md-1 mb-1">
                            <input type="number" class="form-control" name="entry_max" value="<?php echo $rr['entry_max'] ?>">
                        </div>
                        <div class="col-md-1 mb-1">
                            <input type="number" class="form-control" name="entry_won" value="<?php echo $rr['entry_won'] ?>">
                        </div>
