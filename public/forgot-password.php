        ...
        <?php if (!$submit_attempt || $error_message) { ?>
            <div class="form-label-group">
                <input type="username" id="inputUsername" class="form-control" placeholder="Username"
                       name="username" <?php if ($_SESSION['loggedin']) {
        ...
        if ($submit_attempt) {
            ...
            <?php } else { ?>
                <div class="p-2 alert-success text-center alert">
                    <p>An email was sent to the provided username's email address.<br/><br/>Please check your email and
                        click on included link to reset your password.</p>
                </div>
                <?php
            }
        }
