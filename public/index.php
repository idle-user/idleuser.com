...
<body>
    ...
    <div id="projects" class="container rounded text-center p-5">
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <h2>Matches</h2>
          <p>Wager points against others on upcoming wrestling matches. Rank up on the leaderboard and rate your favorite matches.</p>
          <p><a class="btn btn-secondary shadow" href="/projects/matches/" target="_blank" role="button">Visit Page</a></p>
        </div>
        <div class="col-lg-4">
        <p class="display-3"><i class="fas fa-poll-h"></i>
          ...
          <p><a class="btn btn-secondary shadow" href="/projects/create-a-poll/" target="_blank" role="button">Visit Page</a></p>
        </div>
        <div class="col-lg-4">
        ...
        <p class="container pt-3"><a class="btn btn-secondary btn-lg shadow" href="https://github.com/idle-user" target="_blank" role="button">Other Projects</a></p>
    ...
    <div id="services" class="container rounded text-center p-5 mb-5 bg-light shadow">
      ...
      <div class="row">
        <div class="col-lg-4">
          <h2>Consultant</h2>
          <p>Whether you're creating your first website or troubleshooting a software bug, I can be there to help at any step of the way. I have <strong>years of experience</strong> in database management, well-versed in many programming languages, and have personally designed, developed and hosted websites from scratch.</p>
        </div>
        <div class="col-lg-4">
          <h2>Web Applications</h2>
          <p>Do you have mundane or repetitive tasks that you know could be automated? Tell me about it, and I will create a web application to meet your requirements.</p>
        </div>
        <div class="col-lg-4">
          <h2>Discord Bot</h2>
