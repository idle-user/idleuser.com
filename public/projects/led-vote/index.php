            ...
            <div class="6u$ 12u$(medium) important(medium)">
                ...
                <div id="entry_div">
                    <div class="row uniform 50%">
                        <div class="12u$">
                            <ul class="actions">
                                <li><input type="submit" value="Login" class="special"
                                           onclick="location.href='/login?<?php echo get_direct_to(); ?>';"/></li>
                                <li><input type="submit" value="Register" class="special"
                                           onclick="location.href='/register?<?php echo get_direct_to(); ?>';"/></li>
                            </ul>
                        </div>
                    </div>
                </div>
