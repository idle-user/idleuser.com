            ...
            <div class="container">
                ...
                <?php if (!$_SESSION['loggedin']) { ?>
                    <div class="alert alert-warning">
                        ...
                        <a href="/login?<?php echo get_direct_to(); ?>" class="btn btn-secondary my-2">Register /
                            Login</a>
                    </div>
                <?php } else { ?>
                ...
                <form method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputTopic"
                                   placeholder="Enter the Topic/Question" name="topic" maxlength="100" required>
                        </div>
                    </div>
                    ...
                    <div class="m-3" id="inputItemList">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control form-control-sm" id="inputTopic"
                                       placeholder="Enter option value" name="item[]" maxlength="50" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="multiCheck">
                                    Allow multiple options? <i class="fas fa-info-circle"
                                                               title="Check to allow a poll vote to contain more than one option."></i>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="hideVotes" name="hideVotes" checked>
                                <label class="form-check-label" for="hideVotes">
                                    Hide results until voted? <i class="fas fa-info-circle"
                                                                 title="Check to hide the poll votes and chart until after a vote is submitted."></i>
                                </label>
                            </div>
                        </div>
                    </div>
