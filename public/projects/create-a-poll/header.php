        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-md-7 py-4">
                    ...
                    <p class="text-muted">Create and share a poll with others. Register and sign-in to track your poll
                        history. Unregistered polls will automatically close after 24 hours.</p>
                </div>
    ...
    <div class="navbar navbar-dark bg-dark shadow-sm">
        <div class="container d-flex justify-content-between">
            <a href="./" class="navbar-brand d-flex align-items-center">
                <svg width="1.5em" height="1em" viewBox="0 0 16 16" class="bi bi-bar-chart-line-fill"
            ...
            <div class="row">
                <?php if ($_SESSION['loggedin']) { ?>
                    <button type="button" class="btn btn-secondary float-right mr-4" data-toggle="modal"
