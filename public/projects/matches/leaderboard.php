    ...
    <table class="alt">
        ...
        foreach ($leaderboard as $user) { ?>
            <tr>
                <td><?php echo $cnt; ?></td>
                <td>
                    <a href="/projects/matches/user?user_id=<?php echo $user['user_id']; ?>"><?php echo $user['username']; ?></a>
                </td>
                <td>
                    <a href="/projects/matches/superstar?superstar_id=<?php echo $user['favorite_superstar_id']; ?>"><?php echo $db->superstar($user['favorite_superstar_id'])['name'] ?></a>
                </td>
