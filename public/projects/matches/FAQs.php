...
<section>
    ...
    <p>Matches is a website that lets you wager <i>points</i> on current and upcoming matches. You win or lose points
        depending on the outcome of the match. So it's like a simplified Fantasy Football for wrestling</p>
...
<section>
    ...
    <p>Still trying to figure out what to provide in the shop, so if you have any ideas, please let me know through a
        feedback. I'd appreciate it.</p>
</section>
<hr class="major"/>
<section>
    <header class="main">
