...
<header class="main">
    ...
    <p>Test your luck in this year's Royal Rumble<br/>Get an entry number and watch to see if your entrant is the
        winner!</p>
</header>
<hr class="major"/>
        ...
        <div class="row uniform">
            <div class="12u row">
                <div class="4u">
                    ...
                    <input type="text" name="display_name" id="entry_username" maxlength="20"
                           placeholder="required" <?php if ($_SESSION['loggedin']) {
                        echo 'value="' . $_SESSION['profile']['username'] . '" readonly="readonly"';
                    } ?> required/>
                </div>
                <div class="6u">
                ...
                <div class="6u">
                    ...
                    <select name="royalrumble_id" id="entry_event" required>
                        ...
                        foreach ($all_entries as $entries) {
                            ...
                            echo '<option value="' . $entries[0]['royalrumble_id'] . '">' . $entries[0]['event_name'];
                            if ($entries[0]['description']) echo ' (' . $entries[0]['description'] . ')';
                            echo '</option>';
                        }
                        ?>
                    </select>
                ...
                foreach ($entries as $entrant) {
                    ...
                    <tr>
                        <?php if ($entrant['user_id']) { ?>
                            <td>
                                <a href="/projects/matches/user?user_id=<?php echo $entrant['user_id']; ?>"><?php echo $entrant['display_name']; ?></a>
                            </td>
                        <?php } else { ?>
