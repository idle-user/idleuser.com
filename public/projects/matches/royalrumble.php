		...
		<div class="row uniform">
			<div class="12u row">
				<div class="4u">
					...
					<input type="text" name="display_name" id="entry_username" maxlength="20" placeholder="required" <?php if($_SESSION['loggedin']){ echo 'value="'.$_SESSION['profile']['username'].'" readonly="readonly"'; } ?> required />
				</div>
				<div class="6u">
