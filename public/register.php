...
<head>
    ...
    <?php
    $meta = ["viewport" => "width=device-width, initial-scale=1, user-scalable=no", "keywords" => "account, login, register, logout", "og:title" => "IdleUser - Register", "og:description" => "Account register page for " . getenv('DOMAIN')];
    echo page_meta($meta);
    ?>
...
<div class="main">
    <form class="form-signin" method="post"
          oninput="inputPasswordVerify.setCustomValidity(inputPasswordVerify.value != inputPassword.value ? 'Passwords do not match.' : '')">
        <div class="text-center mb-4">
            ...
            <p>Register an account. Use your IdleUser Account across the entire website, including <a
        ...
        <div class="form-label-group">
            <input type="username" id="inputUsername" class="form-control" placeholder="Username" name="username"
                   maxlength="25" <?php if (isset($_POST['username'])) {
        ...
        <div class="form-label-group">
            <input type="password" id="inputPasswordVerify" class="form-control" placeholder="Verify Password"
                   name="secret_verify" minlength="6" required>
