...
<div class="main">
    <form class="form-signin" method="post"
        ...
        <div class="text-center mb-4">
            ...
            <p>Reset your account password. Use your IdleUser Account across the entire website, including <a
                        href="/projects/matches/">Matches</a> and <a href="/projects/create-a-poll/">Create-a-Poll</a>.
            </p>
        </div>

        <div class="form-label-group">
            <input type="text" id="inputResetToken" class="form-control d-none" placeholder="Reset Token"
                   name="reset_token" value="<?= $_GET['reset_token'] ?>" required readonly>
