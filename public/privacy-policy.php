...
<head>
    ...
    $meta = [
        ...
        "og:description" => "Privacy Policy page for " . getenv('DOMAIN')
    ];
    echo page_meta($meta);
    ?>
...
<main role="main">
    <div class="jumbotron container-fluid">
        <h1>Privacy Policy of <?php echo getenv('DOMAIN'); ?></h1>

        <p><?php echo getenv('DOMAIN'); ?> operates the <?php echo getenv('WEBSITE'); ?> website, which provides the
            SERVICE.</p>

        <p>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure
            of Personal Information if anyone decided to use our Service, the IdleUser website.</p>
        ...
        <p>If you choose to use our Service, then you agree to the collection and use of information in relation with
            ...
            will not use or share your information with anyone except as described in this Privacy Policy. Our Privacy
            Policy was created with the help of the <a href="https://www.privacypolicytemplate.net">Privacy Policy
                Template</a> and the <a href="https://www.generateprivacypolicy.com">Privacy Policy Generator</a>.</p>

        <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is
            accessible at https://idleusesr.com, unless otherwise defined in this Privacy Policy.</p>
