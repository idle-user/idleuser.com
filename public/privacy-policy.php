...
<main role="main">
    <div class="jumbotron container-fluid">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to <?php echo getenv('DOMAIN'); ?> .</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to <?php echo getenv('DOMAIN'); ?>, accessible from <a href=" <?php echo getenv('WEBSITE'); ?>" rel="external nofollow noopener" target="_blank"><?php echo getenv('WEBSITE'); ?></a></p>
            </li>
            <li>
        ...
        <ul>
            <li>By visiting this page on our website: <a href="/contact" rel="external nofollow noopener" target="_blank"> <?php echo getenv('WEBSITE'); ?>contact</a></li>
        </ul>
    </div>
</main>
